...
size_t str_index(const std::vector<string>& vs, const string& s)
{
...
size_t str_index(const std::vector<string>& vs, const char* s)
{
    for (size_t i = 0; i < vs.size(); ++i) {
...
int main(int argc, char* argv[])
{
    ...
    std::vector<string> element, magtype, property, vstring;
